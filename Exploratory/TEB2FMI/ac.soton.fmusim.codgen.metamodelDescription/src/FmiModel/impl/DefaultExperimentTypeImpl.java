...
public class DefaultExperimentTypeImpl extends EObjectImpl implements DefaultExperimentType {
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.DEFAULT_EXPERIMENT_TYPE;
	}
	...
	public void setStartTime(double newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.DEFAULT_EXPERIMENT_TYPE__START_TIME, oldStartTime, startTime, !oldStartTimeESet));
	}
	...
	public void unsetStartTime() {
		...
		startTimeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.DEFAULT_EXPERIMENT_TYPE__START_TIME, oldStartTime, START_TIME_EDEFAULT, oldStartTimeESet));
	}
	...
	public void setStopTime(double newStopTime) {
		...
		stopTimeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.DEFAULT_EXPERIMENT_TYPE__STOP_TIME, oldStopTime, stopTime, !oldStopTimeESet));
	}
	...
	public void unsetStopTime() {
		...
		stopTimeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.DEFAULT_EXPERIMENT_TYPE__STOP_TIME, oldStopTime, STOP_TIME_EDEFAULT, oldStopTimeESet));
	}
	...
	public void setTolerance(double newTolerance) {
		...
		toleranceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.DEFAULT_EXPERIMENT_TYPE__TOLERANCE, oldTolerance, tolerance, !oldToleranceESet));
	}
	...
	public void unsetTolerance() {
		...
		toleranceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.DEFAULT_EXPERIMENT_TYPE__TOLERANCE, oldTolerance, TOLERANCE_EDEFAULT, oldToleranceESet));
	}
