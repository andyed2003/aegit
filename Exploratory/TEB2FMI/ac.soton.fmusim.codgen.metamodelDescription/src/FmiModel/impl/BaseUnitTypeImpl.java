 ...
 * <ul>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getA <em>A</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getCd <em>Cd</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getK <em>K</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getKg <em>Kg</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getM <em>M</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getMol <em>Mol</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getRad <em>Rad</em>}</li>
 *   <li>{@link FmiModel.impl.BaseUnitTypeImpl#getS <em>S</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BaseUnitTypeImpl extends EObjectImpl implements BaseUnitType {
	/**
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.BASE_UNIT_TYPE;
	}
	...
	public void setA(int newA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__A, oldA, a, !oldAESet));
	}
	...
	public void unsetA() {
		...
		aESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__A, oldA, A_EDEFAULT, oldAESet));
	}
	...
	public void setCd(int newCd) {
		...
		cdESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__CD, oldCd, cd, !oldCdESet));
	}
	...
	public void unsetCd() {
		...
		cdESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__CD, oldCd, CD_EDEFAULT, oldCdESet));
	}
	...
	public void setFactor(double newFactor) {
		...
		factorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__FACTOR, oldFactor, factor, !oldFactorESet));
	}
	...
	public void unsetFactor() {
		...
		factorESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__FACTOR, oldFactor, FACTOR_EDEFAULT, oldFactorESet));
	}
	...
	public void setK(int newK) {
		...
		kESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__K, oldK, k, !oldKESet));
	}
	...
	public void unsetK() {
		...
		kESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__K, oldK, K_EDEFAULT, oldKESet));
	}
	...
	public void setKg(int newKg) {
		...
		kgESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__KG, oldKg, kg, !oldKgESet));
	}
	...
	public void unsetKg() {
		...
		kgESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__KG, oldKg, KG_EDEFAULT, oldKgESet));
	}
	...
	public void setM(int newM) {
		...
		mESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__M, oldM, m, !oldMESet));
	}
	...
	public void unsetM() {
		...
		mESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__M, oldM, M_EDEFAULT, oldMESet));
	}
	...
	public void setMol(int newMol) {
		...
		molESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__MOL, oldMol, mol, !oldMolESet));
	}
	...
	public void unsetMol() {
		...
		molESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__MOL, oldMol, MOL_EDEFAULT, oldMolESet));
	}
	...
	public void setOffset(double newOffset) {
		...
		offsetESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__OFFSET, oldOffset, offset, !oldOffsetESet));
	}
	...
	public void unsetOffset() {
		...
		offsetESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__OFFSET, oldOffset, OFFSET_EDEFAULT, oldOffsetESet));
	}
	...
	public void setRad(int newRad) {
		...
		radESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__RAD, oldRad, rad, !oldRadESet));
	}
	...
	public void unsetRad() {
		...
		radESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__RAD, oldRad, RAD_EDEFAULT, oldRadESet));
	}
	...
	public void setS(int newS) {
		...
		sESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BASE_UNIT_TYPE__S, oldS, s, !oldSESet));
	}
	...
	public void unsetS() {
		...
		sESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BASE_UNIT_TYPE__S, oldS, S_EDEFAULT, oldSESet));
	}
