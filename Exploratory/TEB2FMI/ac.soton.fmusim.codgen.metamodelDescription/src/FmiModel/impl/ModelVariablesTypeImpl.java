 ...
 * <ul>
 *   <li>{@link FmiModel.impl.ModelVariablesTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link FmiModel.impl.ModelVariablesTypeImpl#getScalarVariable <em>Scalar Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelVariablesTypeImpl extends EObjectImpl implements ModelVariablesType {
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.MODEL_VARIABLES_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, FmiModelPackage.MODEL_VARIABLES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<FmiScalarVariable> getScalarVariable() {
		return getGroup().list(FmiModelPackage.Literals.MODEL_VARIABLES_TYPE__SCALAR_VARIABLE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FmiModelPackage.MODEL_VARIABLES_TYPE__SCALAR_VARIABLE:
