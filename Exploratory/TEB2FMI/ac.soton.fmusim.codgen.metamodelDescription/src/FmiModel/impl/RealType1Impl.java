 ...
 * <ul>
 *   <li>{@link FmiModel.impl.RealType1Impl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getDisplayUnit <em>Display Unit</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getMax <em>Max</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getMin <em>Min</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getNominal <em>Nominal</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#isRelativeQuantity <em>Relative Quantity</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getStart <em>Start</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#isUnbounded <em>Unbounded</em>}</li>
 *   <li>{@link FmiModel.impl.RealType1Impl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RealType1Impl extends EObjectImpl implements RealType1 {
	/**
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.REAL_TYPE1;
	}
	...
	public void setDeclaredType(String newDeclaredType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__DECLARED_TYPE, oldDeclaredType, declaredType));
	}
	...
	public void setDisplayUnit(String newDisplayUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__DISPLAY_UNIT, oldDisplayUnit, displayUnit));
	}
	...
	public void setMax(double newMax) {
		...
		maxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__MAX, oldMax, max, !oldMaxESet));
	}
	...
	public void unsetMax() {
		...
		maxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE1__MAX, oldMax, MAX_EDEFAULT, oldMaxESet));
	}
	...
	public void setMin(double newMin) {
		...
		minESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__MIN, oldMin, min, !oldMinESet));
	}
	...
	public void unsetMin() {
		...
		minESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE1__MIN, oldMin, MIN_EDEFAULT, oldMinESet));
	}
	...
	public void setNominal(double newNominal) {
		...
		nominalESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__NOMINAL, oldNominal, nominal, !oldNominalESet));
	}
	...
	public void unsetNominal() {
		...
		nominalESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE1__NOMINAL, oldNominal, NOMINAL_EDEFAULT, oldNominalESet));
	}
	...
	public void setQuantity(String newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setRelativeQuantity(boolean newRelativeQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__RELATIVE_QUANTITY, oldRelativeQuantity, relativeQuantity, !oldRelativeQuantityESet));
	}
	...
	public void unsetRelativeQuantity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE1__RELATIVE_QUANTITY, oldRelativeQuantity, RELATIVE_QUANTITY_EDEFAULT, oldRelativeQuantityESet));
	}
	...
	public void setStart(double newStart) {
		...
		startESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__START, oldStart, start, !oldStartESet));
	}
	...
	public void unsetStart() {
		...
		startESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE1__START, oldStart, START_EDEFAULT, oldStartESet));
	}
	...
	public void setUnbounded(boolean newUnbounded) {
		...
		unboundedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__UNBOUNDED, oldUnbounded, unbounded, !oldUnboundedESet));
	}
	...
	public void unsetUnbounded() {
		...
		unboundedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE1__UNBOUNDED, oldUnbounded, UNBOUNDED_EDEFAULT, oldUnboundedESet));
	}
	...
	public void setUnit(String newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE1__UNIT, oldUnit, unit));
	}
