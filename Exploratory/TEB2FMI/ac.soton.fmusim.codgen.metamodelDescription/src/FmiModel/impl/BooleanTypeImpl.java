 ...
 * <ul>
 *   <li>{@link FmiModel.impl.BooleanTypeImpl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link FmiModel.impl.BooleanTypeImpl#isStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanTypeImpl extends EObjectImpl implements BooleanType {
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.BOOLEAN_TYPE;
	}
	...
	public void setDeclaredType(String newDeclaredType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BOOLEAN_TYPE__DECLARED_TYPE, oldDeclaredType, declaredType));
	}
	...
	public void setStart(boolean newStart) {
		...
		startESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.BOOLEAN_TYPE__START, oldStart, start, !oldStartESet));
	}
	...
	public void unsetStart() {
		...
		startESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.BOOLEAN_TYPE__START, oldStart, START_EDEFAULT, oldStartESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FmiModelPackage.BOOLEAN_TYPE__DECLARED_TYPE:
				return getDeclaredType();
			case FmiModelPackage.BOOLEAN_TYPE__START:
				return isStart();
		}
