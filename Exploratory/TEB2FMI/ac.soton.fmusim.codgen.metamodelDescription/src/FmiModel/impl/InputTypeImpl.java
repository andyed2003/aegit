 ...
 * <ul>
 *   <li>{@link FmiModel.impl.InputTypeImpl#getDerivative <em>Derivative</em>}</li>
 *   <li>{@link FmiModel.impl.InputTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputTypeImpl extends EObjectImpl implements InputType {
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.INPUT_TYPE;
	}
	...
	public void setDerivative(int newDerivative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.INPUT_TYPE__DERIVATIVE, oldDerivative, derivative, !oldDerivativeESet));
	}
	...
	public void unsetDerivative() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.INPUT_TYPE__DERIVATIVE, oldDerivative, DERIVATIVE_EDEFAULT, oldDerivativeESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.INPUT_TYPE__NAME, oldName, name));
	}
