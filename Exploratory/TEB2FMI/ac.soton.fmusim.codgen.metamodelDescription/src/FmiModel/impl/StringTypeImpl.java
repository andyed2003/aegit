 ...
 * <ul>
 *   <li>{@link FmiModel.impl.StringTypeImpl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link FmiModel.impl.StringTypeImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringTypeImpl extends EObjectImpl implements StringType {
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.STRING_TYPE;
	}
	...
	public void setDeclaredType(String newDeclaredType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.STRING_TYPE__DECLARED_TYPE, oldDeclaredType, declaredType));
	}
	...
	public void setStart(String newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.STRING_TYPE__START, oldStart, start));
	}
