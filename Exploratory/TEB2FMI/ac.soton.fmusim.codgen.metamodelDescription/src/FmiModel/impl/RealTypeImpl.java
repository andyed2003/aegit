 ...
 * <ul>
 *   <li>{@link FmiModel.impl.RealTypeImpl#getDisplayUnit <em>Display Unit</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#getNominal <em>Nominal</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#isRelativeQuantity <em>Relative Quantity</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#isUnbounded <em>Unbounded</em>}</li>
 *   <li>{@link FmiModel.impl.RealTypeImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealTypeImpl extends EObjectImpl implements RealType {
	...
	protected EClass eStaticClass() {
		return FmiModelPackage.Literals.REAL_TYPE;
	}
	...
	public void setDisplayUnit(String newDisplayUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__DISPLAY_UNIT, oldDisplayUnit, displayUnit));
	}
	...
	public void setMax(double newMax) {
		...
		maxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__MAX, oldMax, max, !oldMaxESet));
	}
	...
	public void unsetMax() {
		...
		maxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE__MAX, oldMax, MAX_EDEFAULT, oldMaxESet));
	}
	...
	public void setMin(double newMin) {
		...
		minESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__MIN, oldMin, min, !oldMinESet));
	}
	...
	public void unsetMin() {
		...
		minESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE__MIN, oldMin, MIN_EDEFAULT, oldMinESet));
	}
	...
	public void setNominal(double newNominal) {
		...
		nominalESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__NOMINAL, oldNominal, nominal, !oldNominalESet));
	}
	...
	public void unsetNominal() {
		...
		nominalESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE__NOMINAL, oldNominal, NOMINAL_EDEFAULT, oldNominalESet));
	}
	...
	public void setQuantity(String newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setRelativeQuantity(boolean newRelativeQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__RELATIVE_QUANTITY, oldRelativeQuantity, relativeQuantity, !oldRelativeQuantityESet));
	}
	...
	public void unsetRelativeQuantity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE__RELATIVE_QUANTITY, oldRelativeQuantity, RELATIVE_QUANTITY_EDEFAULT, oldRelativeQuantityESet));
	}
	...
	public void setUnbounded(boolean newUnbounded) {
		...
		unboundedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__UNBOUNDED, oldUnbounded, unbounded, !oldUnboundedESet));
	}
	...
	public void unsetUnbounded() {
		...
		unboundedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelPackage.REAL_TYPE__UNBOUNDED, oldUnbounded, UNBOUNDED_EDEFAULT, oldUnboundedESet));
	}
	...
	public void setUnit(String newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelPackage.REAL_TYPE__UNIT, oldUnit, unit));
	}
