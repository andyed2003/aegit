 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.impl.StringTypeImpl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.StringTypeImpl#isFixed <em>Fixed</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.StringTypeImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringTypeImpl extends EObjectImpl implements StringType {
	...
	protected EClass eStaticClass() {
		return FmiModelDescriptionV1Package.Literals.STRING_TYPE;
	}
	...
	public void setDeclaredType(String newDeclaredType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.STRING_TYPE__DECLARED_TYPE, oldDeclaredType, declaredType));
	}
	...
	public void setFixed(boolean newFixed) {
		...
		fixedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.STRING_TYPE__FIXED, oldFixed, fixed, !oldFixedESet));
	}
	...
	public void unsetFixed() {
		...
		fixedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.STRING_TYPE__FIXED, oldFixed, FIXED_EDEFAULT, oldFixedESet));
	}
	...
	public void setStart(String newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.STRING_TYPE__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FmiModelDescriptionV1Package.STRING_TYPE__DECLARED_TYPE:
				return getDeclaredType();
			case FmiModelDescriptionV1Package.STRING_TYPE__FIXED:
				return isFixed();
			case FmiModelDescriptionV1Package.STRING_TYPE__START:
				return getStart();
		}
