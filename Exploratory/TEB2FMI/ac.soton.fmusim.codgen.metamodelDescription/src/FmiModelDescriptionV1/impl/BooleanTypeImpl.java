 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.impl.BooleanTypeImpl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.BooleanTypeImpl#isFixed <em>Fixed</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.BooleanTypeImpl#isStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanTypeImpl extends EObjectImpl implements BooleanType {
	...
	protected EClass eStaticClass() {
		return FmiModelDescriptionV1Package.Literals.BOOLEAN_TYPE;
	}
	...
	public void setDeclaredType(String newDeclaredType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.BOOLEAN_TYPE__DECLARED_TYPE, oldDeclaredType, declaredType));
	}
	...
	public void setFixed(boolean newFixed) {
		...
		fixedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.BOOLEAN_TYPE__FIXED, oldFixed, fixed, !oldFixedESet));
	}
	...
	public void unsetFixed() {
		...
		fixedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.BOOLEAN_TYPE__FIXED, oldFixed, FIXED_EDEFAULT, oldFixedESet));
	}
	...
	public void setStart(boolean newStart) {
		...
		startESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.BOOLEAN_TYPE__START, oldStart, start, !oldStartESet));
	}
	...
	public void unsetStart() {
		...
		startESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.BOOLEAN_TYPE__START, oldStart, START_EDEFAULT, oldStartESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FmiModelDescriptionV1Package.BOOLEAN_TYPE__DECLARED_TYPE:
				return getDeclaredType();
			case FmiModelDescriptionV1Package.BOOLEAN_TYPE__FIXED:
				return isFixed();
			case FmiModelDescriptionV1Package.BOOLEAN_TYPE__START:
				return isStart();
		}
