 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#getDisplayUnit <em>Display Unit</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#getNominal <em>Nominal</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#isRelativeQuantity <em>Relative Quantity</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.RealTypeTypeImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealTypeTypeImpl extends EObjectImpl implements RealTypeType {
	...
	protected EClass eStaticClass() {
		return FmiModelDescriptionV1Package.Literals.REAL_TYPE_TYPE;
	}
	...
	public void setDisplayUnit(String newDisplayUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__DISPLAY_UNIT, oldDisplayUnit, displayUnit));
	}
	...
	public void setMax(double newMax) {
		...
		maxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__MAX, oldMax, max, !oldMaxESet));
	}
	...
	public void unsetMax() {
		...
		maxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__MAX, oldMax, MAX_EDEFAULT, oldMaxESet));
	}
	...
	public void setMin(double newMin) {
		...
		minESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__MIN, oldMin, min, !oldMinESet));
	}
	...
	public void unsetMin() {
		...
		minESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__MIN, oldMin, MIN_EDEFAULT, oldMinESet));
	}
	...
	public void setNominal(double newNominal) {
		...
		nominalESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__NOMINAL, oldNominal, nominal, !oldNominalESet));
	}
	...
	public void unsetNominal() {
		...
		nominalESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__NOMINAL, oldNominal, NOMINAL_EDEFAULT, oldNominalESet));
	}
	...
	public void setQuantity(String newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setRelativeQuantity(boolean newRelativeQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__RELATIVE_QUANTITY, oldRelativeQuantity, relativeQuantity, !oldRelativeQuantityESet));
	}
	...
	public void unsetRelativeQuantity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__RELATIVE_QUANTITY, oldRelativeQuantity, RELATIVE_QUANTITY_EDEFAULT, oldRelativeQuantityESet));
	}
	...
	public void setUnit(String newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.REAL_TYPE_TYPE__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__DISPLAY_UNIT:
				return getDisplayUnit();
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__MAX:
				return getMax();
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__MIN:
				return getMin();
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__NOMINAL:
				return getNominal();
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__QUANTITY:
				return getQuantity();
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__RELATIVE_QUANTITY:
				return isRelativeQuantity();
			case FmiModelDescriptionV1Package.REAL_TYPE_TYPE__UNIT:
				return getUnit();
		}
