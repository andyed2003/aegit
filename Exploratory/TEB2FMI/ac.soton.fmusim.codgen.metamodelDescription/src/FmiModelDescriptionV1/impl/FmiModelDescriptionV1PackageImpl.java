...
import FmiModelDescriptionV1.AnnotationType;
...
import FmiModelDescriptionV1.CoSimulation_Tool;
import FmiModelDescriptionV1.DefaultExperimentType;
import FmiModelDescriptionV1.DirectDependencyType;
import FmiModelDescriptionV1.DisplayUnitDefinitionType;
...
import FmiModelDescriptionV1.ItemType;
 ...
 * @generated
 */
public class FmiModelDescriptionV1PackageImpl extends EPackageImpl implements FmiModelDescriptionV1Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FmiModelDescriptionV1PackageImpl() {
		super(eNS_URI, FmiModelDescriptionV1Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FmiModelDescriptionV1Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FmiModelDescriptionV1Package init() {
		if (isInited) return (FmiModelDescriptionV1Package)EPackage.Registry.INSTANCE.getEPackage(FmiModelDescriptionV1Package.eNS_URI);

		// Obtain or create and register package
		FmiModelDescriptionV1PackageImpl theFmiModelDescriptionV1Package = (FmiModelDescriptionV1PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FmiModelDescriptionV1PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FmiModelDescriptionV1PackageImpl());
		...
		theFmiModelDescriptionV1Package.createPackageContents();

		// Initialize created meta-data
		theFmiModelDescriptionV1Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFmiModelDescriptionV1Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FmiModelDescriptionV1Package.eNS_URI, theFmiModelDescriptionV1Package);
		return theFmiModelDescriptionV1Package;
	}
	 ...
	 * @generated
	 */
	public EReference getImplementationType_FmiImplementation() {
	 ...
	 * @generated
	 */
	public FmiModelDescriptionV1Factory getFmiModelDescriptionV1Factory() {
		return (FmiModelDescriptionV1Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(implementationTypeEClass, IMPLEMENTATION_TYPE__FMI_IMPLEMENTATION);
	...
	public void initializePackageContents() {
		...
		initEReference(getImplementationType_FmiImplementation(), this.getImplementation(), null, "fmiImplementation", null, 0, 1, ImplementationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //FmiModelDescriptionV1PackageImpl
