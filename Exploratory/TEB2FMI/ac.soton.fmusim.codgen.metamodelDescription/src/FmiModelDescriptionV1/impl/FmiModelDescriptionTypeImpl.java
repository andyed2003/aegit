...
import FmiModelDescriptionV1.DefaultExperimentType;
...
import FmiModelDescriptionV1.TypeDefinitionsType;
import FmiModelDescriptionV1.UnitDefinitionsType;
import FmiModelDescriptionV1.VariableNamingConventionType;
import FmiModelDescriptionV1.VendorAnnotationsType;
 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getUnitDefinitions <em>Unit Definitions</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getTypeDefinitions <em>Type Definitions</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getDefaultExperiment <em>Default Experiment</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getVendorAnnotations <em>Vendor Annotations</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getModelVariables <em>Model Variables</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getFmiVersion <em>Fmi Version</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getGenerationDateAndTime <em>Generation Date And Time</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getGenerationTool <em>Generation Tool</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getGuid <em>Guid</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getModelIdentifier <em>Model Identifier</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getModelName <em>Model Name</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getNumberOfContinuousStates <em>Number Of Continuous States</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getNumberOfEventIndicators <em>Number Of Event Indicators</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getVariableNamingConvention <em>Variable Naming Convention</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.FmiModelDescriptionTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FmiModelDescriptionTypeImpl extends EObjectImpl implements FmiModelDescriptionType {
	...
	protected EClass eStaticClass() {
		return FmiModelDescriptionV1Package.Literals.FMI_MODEL_DESCRIPTION_TYPE;
	}
	...
	public NotificationChain basicSetUnitDefinitions(UnitDefinitionsType newUnitDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__UNIT_DEFINITIONS, oldUnitDefinitions, newUnitDefinitions);
	...
	public void setUnitDefinitions(UnitDefinitionsType newUnitDefinitions) {
		if (newUnitDefinitions != unitDefinitions) {
			...
			if (unitDefinitions != null)
				msgs = ((InternalEObject)unitDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__UNIT_DEFINITIONS, null, msgs);
			if (newUnitDefinitions != null)
				msgs = ((InternalEObject)newUnitDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__UNIT_DEFINITIONS, null, msgs);
			msgs = basicSetUnitDefinitions(newUnitDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__UNIT_DEFINITIONS, newUnitDefinitions, newUnitDefinitions));
	}
	...
	public NotificationChain basicSetTypeDefinitions(TypeDefinitionsType newTypeDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__TYPE_DEFINITIONS, oldTypeDefinitions, newTypeDefinitions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTypeDefinitions(TypeDefinitionsType newTypeDefinitions) {
		if (newTypeDefinitions != typeDefinitions) {
			...
			if (typeDefinitions != null)
				msgs = ((InternalEObject)typeDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__TYPE_DEFINITIONS, null, msgs);
			if (newTypeDefinitions != null)
				msgs = ((InternalEObject)newTypeDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__TYPE_DEFINITIONS, null, msgs);
			msgs = basicSetTypeDefinitions(newTypeDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__TYPE_DEFINITIONS, newTypeDefinitions, newTypeDefinitions));
	}
	...
	public NotificationChain basicSetDefaultExperiment(DefaultExperimentType newDefaultExperiment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__DEFAULT_EXPERIMENT, oldDefaultExperiment, newDefaultExperiment);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDefaultExperiment(DefaultExperimentType newDefaultExperiment) {
		if (newDefaultExperiment != defaultExperiment) {
			...
			if (defaultExperiment != null)
				msgs = ((InternalEObject)defaultExperiment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__DEFAULT_EXPERIMENT, null, msgs);
			if (newDefaultExperiment != null)
				msgs = ((InternalEObject)newDefaultExperiment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__DEFAULT_EXPERIMENT, null, msgs);
			msgs = basicSetDefaultExperiment(newDefaultExperiment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__DEFAULT_EXPERIMENT, newDefaultExperiment, newDefaultExperiment));
	}
	...
	public NotificationChain basicSetVendorAnnotations(VendorAnnotationsType newVendorAnnotations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VENDOR_ANNOTATIONS, oldVendorAnnotations, newVendorAnnotations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorAnnotations(VendorAnnotationsType newVendorAnnotations) {
		if (newVendorAnnotations != vendorAnnotations) {
			...
			if (vendorAnnotations != null)
				msgs = ((InternalEObject)vendorAnnotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VENDOR_ANNOTATIONS, null, msgs);
			if (newVendorAnnotations != null)
				msgs = ((InternalEObject)newVendorAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VENDOR_ANNOTATIONS, null, msgs);
			msgs = basicSetVendorAnnotations(newVendorAnnotations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VENDOR_ANNOTATIONS, newVendorAnnotations, newVendorAnnotations));
	}
	...
	public NotificationChain basicSetModelVariables(ModelVariablesType newModelVariables, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__MODEL_VARIABLES, oldModelVariables, newModelVariables);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setModelVariables(ModelVariablesType newModelVariables) {
		if (newModelVariables != modelVariables) {
			...
			if (modelVariables != null)
				msgs = ((InternalEObject)modelVariables).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__MODEL_VARIABLES, null, msgs);
			if (newModelVariables != null)
				msgs = ((InternalEObject)newModelVariables).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__MODEL_VARIABLES, null, msgs);
			msgs = basicSetModelVariables(newModelVariables, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__MODEL_VARIABLES, newModelVariables, newModelVariables));
	}
	...
	public NotificationChain basicSetImplementation(Implementation newImplementation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__IMPLEMENTATION, oldImplementation, newImplementation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setImplementation(Implementation newImplementation) {
		if (newImplementation != implementation) {
			...
			if (implementation != null)
				msgs = ((InternalEObject)implementation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__IMPLEMENTATION, null, msgs);
			if (newImplementation != null)
				msgs = ((InternalEObject)newImplementation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__IMPLEMENTATION, null, msgs);
			msgs = basicSetImplementation(newImplementation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__IMPLEMENTATION, newImplementation, newImplementation));
	}
	...
	public void setAuthor(String newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__AUTHOR, oldAuthor, author));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setFmiVersion(String newFmiVersion) {
		...
		fmiVersionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__FMI_VERSION, oldFmiVersion, fmiVersion, !oldFmiVersionESet));
	}
	...
	public void unsetFmiVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__FMI_VERSION, oldFmiVersion, FMI_VERSION_EDEFAULT, oldFmiVersionESet));
	}
	...
	public void setGenerationDateAndTime(XMLGregorianCalendar newGenerationDateAndTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__GENERATION_DATE_AND_TIME, oldGenerationDateAndTime, generationDateAndTime));
	}
	...
	public void setGenerationTool(String newGenerationTool) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__GENERATION_TOOL, oldGenerationTool, generationTool));
	}
	...
	public void setGuid(String newGuid) {
		...
		guid = newGuid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__GUID, oldGuid, guid));
	}
	...
	public void setModelIdentifier(String newModelIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__MODEL_IDENTIFIER, oldModelIdentifier, modelIdentifier));
	}
	...
	public void setModelName(String newModelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__MODEL_NAME, oldModelName, modelName));
	}
	...
	public void setNumberOfContinuousStates(long newNumberOfContinuousStates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__NUMBER_OF_CONTINUOUS_STATES, oldNumberOfContinuousStates, numberOfContinuousStates, !oldNumberOfContinuousStatesESet));
	}
	...
	public void unsetNumberOfContinuousStates() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__NUMBER_OF_CONTINUOUS_STATES, oldNumberOfContinuousStates, NUMBER_OF_CONTINUOUS_STATES_EDEFAULT, oldNumberOfContinuousStatesESet));
	}
	...
	public void setNumberOfEventIndicators(long newNumberOfEventIndicators) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__NUMBER_OF_EVENT_INDICATORS, oldNumberOfEventIndicators, numberOfEventIndicators, !oldNumberOfEventIndicatorsESet));
	}
	...
	public void unsetNumberOfEventIndicators() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__NUMBER_OF_EVENT_INDICATORS, oldNumberOfEventIndicators, NUMBER_OF_EVENT_INDICATORS_EDEFAULT, oldNumberOfEventIndicatorsESet));
	}
	...
	public void setVariableNamingConvention(VariableNamingConventionType newVariableNamingConvention) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VARIABLE_NAMING_CONVENTION, oldVariableNamingConvention, variableNamingConvention, !oldVariableNamingConventionESet));
	}
	...
	public void unsetVariableNamingConvention() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VARIABLE_NAMING_CONVENTION, oldVariableNamingConvention, VARIABLE_NAMING_CONVENTION_EDEFAULT, oldVariableNamingConventionESet));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.FMI_MODEL_DESCRIPTION_TYPE__VERSION, oldVersion, version));
	}
