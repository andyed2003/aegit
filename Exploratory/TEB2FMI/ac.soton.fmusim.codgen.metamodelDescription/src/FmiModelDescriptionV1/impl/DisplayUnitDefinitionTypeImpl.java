 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.impl.DisplayUnitDefinitionTypeImpl#getDisplayUnit <em>Display Unit</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.DisplayUnitDefinitionTypeImpl#getGain <em>Gain</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.impl.DisplayUnitDefinitionTypeImpl#getOffset <em>Offset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DisplayUnitDefinitionTypeImpl extends EObjectImpl implements DisplayUnitDefinitionType {
	...
	protected EClass eStaticClass() {
		return FmiModelDescriptionV1Package.Literals.DISPLAY_UNIT_DEFINITION_TYPE;
	}
	...
	public void setDisplayUnit(String newDisplayUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__DISPLAY_UNIT, oldDisplayUnit, displayUnit));
	}
	...
	public void setGain(double newGain) {
		...
		gainESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__GAIN, oldGain, gain, !oldGainESet));
	}
	...
	public void unsetGain() {
		...
		gainESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__GAIN, oldGain, GAIN_EDEFAULT, oldGainESet));
	}
	...
	public void setOffset(double newOffset) {
		...
		offsetESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__OFFSET, oldOffset, offset, !oldOffsetESet));
	}
	...
	public void unsetOffset() {
		...
		offsetESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__OFFSET, oldOffset, OFFSET_EDEFAULT, oldOffsetESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__DISPLAY_UNIT:
				return getDisplayUnit();
			case FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__GAIN:
				return getGain();
			case FmiModelDescriptionV1Package.DISPLAY_UNIT_DEFINITION_TYPE__OFFSET:
				return getOffset();
		}
