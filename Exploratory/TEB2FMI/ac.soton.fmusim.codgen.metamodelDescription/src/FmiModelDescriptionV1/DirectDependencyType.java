 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.DirectDependencyType#getGroup <em>Group</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.DirectDependencyType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#getDirectDependencyType()
...
public interface DirectDependencyType extends EObject {
	 ...
	 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#getDirectDependencyType_Group()
	 ...
	 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#getDirectDependencyType_Name()
