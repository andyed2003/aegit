 ...
 * <ul>
 *   <li>{@link FmiModelDescriptionV1.VendorAnnotationsType#getGroup <em>Group</em>}</li>
 *   <li>{@link FmiModelDescriptionV1.VendorAnnotationsType#getTool <em>Tool</em>}</li>
 * </ul>
 * </p>
 *
 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#getVendorAnnotationsType()
...
public interface VendorAnnotationsType extends EObject {
	 ...
	 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#getVendorAnnotationsType_Group()
	 ...
	 * The list contents are of type {@link FmiModelDescriptionV1.ToolType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see FmiModelDescriptionV1.FmiModelDescriptionV1Package#getVendorAnnotationsType_Tool()
