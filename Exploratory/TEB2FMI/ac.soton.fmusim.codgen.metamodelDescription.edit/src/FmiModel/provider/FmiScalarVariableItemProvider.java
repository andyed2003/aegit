...
/**
 * This is the item provider adapter for a {@link FmiModel.FmiScalarVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FmiScalarVariableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__CAUSALITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FmiScalarVariable_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FmiScalarVariable_initial_feature", "_UI_FmiScalarVariable_type"),
				 FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__INITIAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__VALUE_REFERENCE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__VARIABILITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__REAL);
			childrenFeatures.add(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__INTEGER);
			childrenFeatures.add(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__BOOLEAN);
			childrenFeatures.add(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__STRING);
			childrenFeatures.add(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__ENUMERATION);
			childrenFeatures.add(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__ANNOTATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__REAL,
				 FmiModelFactory.eINSTANCE.createRealType1()));

		newChildDescriptors.add
			(createChildParameter
				(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__INTEGER,
				 FmiModelFactory.eINSTANCE.createIntegerType()));

		newChildDescriptors.add
			(createChildParameter
				(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__BOOLEAN,
				 FmiModelFactory.eINSTANCE.createBooleanType()));

		newChildDescriptors.add
			(createChildParameter
				(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__STRING,
				 FmiModelFactory.eINSTANCE.createStringType()));

		newChildDescriptors.add
			(createChildParameter
				(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__ENUMERATION,
				 FmiModelFactory.eINSTANCE.createEnumerationType()));

		newChildDescriptors.add
			(createChildParameter
				(FmiModelPackage.Literals.FMI_SCALAR_VARIABLE__ANNOTATIONS,
