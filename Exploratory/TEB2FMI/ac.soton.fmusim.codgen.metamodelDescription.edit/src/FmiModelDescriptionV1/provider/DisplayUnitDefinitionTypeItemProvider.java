...
/**
 * This is the item provider adapter for a {@link FmiModelDescriptionV1.DisplayUnitDefinitionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelDescriptionV1Package.Literals.DISPLAY_UNIT_DEFINITION_TYPE__DISPLAY_UNIT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelDescriptionV1Package.Literals.DISPLAY_UNIT_DEFINITION_TYPE__GAIN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmiModelDescriptionV1Package.Literals.DISPLAY_UNIT_DEFINITION_TYPE__OFFSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
