...
public class FMUEventWrapperTaskingTranslator extends AbstractTaskingTranslator {
	...
	public IL1Element translate(EventBElement source, IL1Element target,
		...
		Subroutine subroutineTarget = (Subroutine) translationManager
				.translate(actualSource.getEvent());
		
		if(FMUMachineTaskingTranslator.communicatingSubroutines.contains(subroutineTarget)){
			System.out.println("IGNORE this");
			// we should probably repair the taskBody sequence after this
			return null;
		}
