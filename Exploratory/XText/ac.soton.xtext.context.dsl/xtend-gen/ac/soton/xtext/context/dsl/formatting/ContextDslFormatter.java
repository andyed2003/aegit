 ...
 * generated by Xtext
 */
package ac.soton.xtext.context.dsl.formatting;
...
public class ContextDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ContextDslGrammarAccess _contextDslGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._contextDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._contextDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._contextDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._contextDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._contextDslGrammarAccess.getML_COMMENTRule();
