...
* generated by Xtext
*/
package ac.soton.xtext.machine.dsl.parser.antlr;
...
public class MachineDslParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected ac.soton.xtext.machine.dsl.parser.antlr.internal.InternalMachineDslParser createParser(XtextTokenStream stream) {
		return new ac.soton.xtext.machine.dsl.parser.antlr.internal.InternalMachineDslParser(stream, getGrammarAccess());
	}
