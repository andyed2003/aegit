 ...
 * <ul>
 *   <li>{@link statemachineXText.impl.TransitionImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link statemachineXText.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link statemachineXText.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	 ...
	 * @ordered
	 */
	protected static final String EVENT_EDEFAULT = "evt1";
	...
	protected EClass eStaticClass() {
		return StatemachineXTextPackage.Literals.TRANSITION;
	}
	...
	public void setEvent(String newEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatemachineXTextPackage.TRANSITION__EVENT, oldEvent, event));
	}
