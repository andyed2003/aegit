		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStateMachineAccess().getGroup_3_3(), "rule__StateMachine__Group_3_3__0");
					...
					put(grammarAccess.getStateMachineAccess().getNodesAssignment_3_2(), "rule__StateMachine__NodesAssignment_3_2");
					put(grammarAccess.getStateMachineAccess().getNodesAssignment_3_3_1(), "rule__StateMachine__NodesAssignment_3_3_1");
					put(grammarAccess.getStateMachineAccess().getTransitionsAssignment_4_2(), "rule__StateMachine__TransitionsAssignment_4_2");
					put(grammarAccess.getStateMachineAccess().getTransitionsAssignment_4_3_1(), "rule__StateMachine__TransitionsAssignment_4_3_1");
					put(grammarAccess.getStateMachineAccess().getStateMachinesAssignment_5_2(), "rule__StateMachine__StateMachinesAssignment_5_2");
					put(grammarAccess.getStateMachineAccess().getStateMachinesAssignment_5_3_1(), "rule__StateMachine__StateMachinesAssignment_5_3_1");
					put(grammarAccess.getTransitionAccess().getEventAssignment_3_1(), "rule__Transition__EventAssignment_3_1");
					put(grammarAccess.getTransitionAccess().getSourceAssignment_4_1(), "rule__Transition__SourceAssignment_4_1");
					...
					put(grammarAccess.getStateAccess().getNestedAssignment_4_1(), "rule__State__NestedAssignment_4_1");
