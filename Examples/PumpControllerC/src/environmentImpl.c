...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
// THE FOLLOWING GETTERS AND SETTERS/GETTERS SHOULD BE REPLACED BY GENERATED CODE
// WHERE BODIES RETURN FMI_ERROR IF THERE ARE NO VARIABLES OF THAT TYPE
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static fmiReal getReal(fmi_Component* comp, fmiValueReference vr, size_t size, fmiReal value[]){
	return -1;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
// END OF GETTERS AND SETTERS/GETTERS THAT SHOULD BE REPLACED BY GENERATED CODE
// WHERE BODIES RETURN FMI_ERROR IF THERE ARE NO VARIABLES OF THAT TYPE
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// Generated By InitialisationsListGenerator 
		 mc->i [e_level_environmentImpl_] = 90 ; 
		 mc->b [e_pumpOnReq_environmentImpl_] = fmiFalse ; 
		 mc->b [e_pumpOnCmd_environmentImpl_] = fmiFalse ; 
		 mc->b [e_warn_environmentImpl_] = fmiFalse ; 
...
fmi_Component* mc = c;
// Translated code
 mc -> b [ e_pumpOnReq_environmentImpl_ ] = fmiTrue ; 
return fmiOK;
}
